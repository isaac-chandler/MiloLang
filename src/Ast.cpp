...
Type TYPE_S8  = { 1, 1, TYPE_INTEGER_IS_SIGNED, TypeFlavor::INTEGER };
Type TYPE_S16 = { 2, 2, TYPE_INTEGER_IS_SIGNED, TypeFlavor::INTEGER };
Type TYPE_S32 = { 4, 4, TYPE_INTEGER_IS_SIGNED, TypeFlavor::INTEGER };
Type TYPE_S64 = { 8, 8, TYPE_INTEGER_IS_SIGNED, TypeFlavor::INTEGER };
...
Type TYPE_SIGNED_INT_LITERAL = { 0, 0, TYPE_INTEGER_IS_SIGNED | TYPE_IS_INTERNAL, TypeFlavor::INTEGER };
